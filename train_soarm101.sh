...
python lerobot/scripts/control_robot.py \
  ...
  --control.repo_id=${HF_USER}/eval_so101_scissors_2_cameras_act_020000 \
  --control.tags='["so101"]' \
  ...
  --control.policy.path=outputs/train/so101_scissors_2_cameras_act/checkpoints/020000/pretrained_model
